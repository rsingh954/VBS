...
'CHECKING TO SEE IF USER IS IN ITEM INQUIRY, IF NOT STOP SCRIPT
autECLSession.autECLPS.Wait 1000
checkScreen = autECLSession.autECLPS.GetText(01,002,3)
   if checkScreen <>"Ent" Then 
     msgbox "Please Navigate to Item Inquiry"
     Exit Sub
   end if
